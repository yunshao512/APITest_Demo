...
public class DateUtil {
    ...
    * */
     ...
     * 获取当天开始时间可自定义格式
     * */
    public static String getDayBegin(String format) {
        LocalDateTime today_start = LocalDateTime.of(LocalDate.now(), LocalTime.MIN);//当天零点时间
        return today_start.format(DateTimeFormatter.ofPattern(format));
    }
    /*
     * 获取当天结束时间可自定义格式
     * */
    public static String getDayEnd(String format) {
        LocalDateTime today_end = LocalDateTime.of(LocalDate.now(), LocalTime.MAX);//当天最大时间
        return today_end.format(DateTimeFormatter.ofPattern(format));
    }
    /*
     * 获取昨天的开始时间可自定义格式
     * */
    public static String beforeDateStart( String formatEnum ,int daysToAddOrSubtract) {
        LocalDateTime today_start = LocalDateTime.of(LocalDate.now(), LocalTime.MIN);
        return today_start.plusDays(daysToAddOrSubtract).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取昨天的结束时间可自定义格式
     * */
    public static String beforeDateEnd( String formatEnum ,int daysToAddOrSubtract) {
        LocalDateTime today_end = LocalDateTime.of(LocalDate.now(), LocalTime.MAX);
        return today_end.plusDays(daysToAddOrSubtract).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意加某个时间的时间，可自定义格式
     * */
    public static String getDatesPlus(String formatEnum ,int day,int month,int year) {
        LocalDateTime today = LocalDateTime.now();
        return today.plusYears(year).plusMonths(month).plusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意加某个时间的开始时间，可自定义格式
     * */
    public static String getDatesStartPlus(String formatEnum ,int day,int month,int year) {
        LocalDateTime today_start = LocalDateTime.of(LocalDate.now(), LocalTime.MIN);
        return today_start.plusYears(year).plusMonths(month).plusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意加某个时间的结束时间，可自定义格式
     * */
    public static String getDatesEndPlus( String formatEnum ,int day,int month,int year) {
        LocalDateTime today_end = LocalDateTime.of(LocalDate.now(), LocalTime.MAX);
        return today_end.plusYears(year).plusMonths(month).plusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意减某个时间的时间，可自定义格式
     * */
    public static String getDatesMinus(String formatEnum ,int day,int month,int year) {
        LocalDateTime today = LocalDateTime.now();
        return today.minusYears(year).minusMonths(month).minusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意减某个时间的开始时间，可自定义格式
     * */
    public static String getDatesStartMinus(String formatEnum ,int day,int month,int year) {
        LocalDateTime today_start = LocalDateTime.of(LocalDate.now(), LocalTime.MIN);
        return today_start.minusYears(year).minusMonths(month).minusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /*
     * 获取任意减某个时间的结束时间，可自定义格式
     * */
    public static String getDatesEndMinus( String formatEnum ,int day,int month,int year) {
        LocalDateTime today_end = LocalDateTime.of(LocalDate.now(), LocalTime.MAX);
        return today_end.minusYears(year).minusMonths(month).minusDays(day).format(DateTimeFormatter.ofPattern(formatEnum));
    }
    /**
