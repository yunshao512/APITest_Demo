...
public class RandomUtil {
	...
	public static String getRandomCH(int length){
		...
		for (int i = 0;i <length ;i++){
			sb.append(String.valueOf(getRandomHanZi()));
		}
		return sb.toString();
	}
	/**
	...
	public static void main(String args[]) {
		...
		System.out.println(RandomUtil.getRandom(6,false));
		System.out.println(RandomUtil.generateStrArr(6,"12345689"));
		System.out.println(RandomUtil.getRandomArr(6,6,false));
		System.out.println(RandomUtil.getRandomArr(6,6,true));
		System.out.println(RandomUtil.getRandomHanZi());
		System.out.println(RandomUtil.getRandomCH(10));
		System.out.println(RandomUtil.getRandomText(10));
