...
public class ZTestReport implements IReporter {
	...
	private String path = GlobalConfig.getRootDir() + "/test-output/report.html";

	private String templatePath = GlobalConfig.getRootDir()+GlobalConfig.getResourcesDirPath()+"/template/templateReport";
