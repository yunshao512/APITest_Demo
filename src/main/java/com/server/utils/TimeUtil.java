...
/*    *//**
     ...
     * @return
     */
    public static Date getDayCurrentTime(){
        Calendar cal = Calendar.getInstance();

        //获取年月日时分秒
        cal .get(Calendar.YEAR);
        cal .get(Calendar.MONTH) ;  // 0-11，分别表示1-12月
...
//        System.out.println(getDayBegin1());
/*        System.out.println(getNowMonth("2019-09-02"));
        System.out.println("当天开始时间 = "+getDayBegin());
        System.out.println("当天结束时间 = "+getDayEnd());
        System.out.println("昨天开始时间 = "+getBeginDayOfYesterday());
        System.out.println("昨天结束时间 = "+getEndDayOfYesterday());
        System.out.println("明天开始时间 = "+getBeginDayOfTomorrow());
        System.out.println("明天结束时间 = "+getEndDayOfTomorrow());*/
